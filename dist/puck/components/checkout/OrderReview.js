...
export const OrderReview = {
    ...
    render: (raw) => {
        ...
        const ship = raw.shippingMethod;
        const pay = raw.paymentMethod;
        ...
        const processingText = raw.processingText ?? 'Placing order…';
        return (_jsxs("div", { className: "border border-gray-200 rounded-lg p-6 bg-white", children: [_jsxs("div", { className: "flex items-center gap-3 mb-6 pb-4 border-b border-gray-200", children: [_jsx(Check, {}), _jsx("h2", { className: "text-xl font-semibold text-gray-900", children: "Review Your Order" })] }), _jsxs("div", { className: "space-y-4 mb-6", children: [_jsxs("div", { className: "border border-gray-100 rounded-lg p-4 bg-gray-50", children: [_jsx("h3", { className: "font-medium text-gray-900 mb-3", children: "Shipping to:" }), addr ? (_jsxs(_Fragment, { children: [_jsxs("p", { className: "text-sm text-gray-700", children: [addr.name, _jsx("br", {}), addr.street, _jsx("br", {}), addr.city, ", ", addr.state, " ", addr.zip, _jsx("br", {}), addr.country] }), addr.email && _jsx("p", { className: "text-sm text-gray-600 mt-2", children: addr.email })] })) : (_jsx("p", { className: "text-sm text-gray-500", children: "Please complete the shipping step." }))] }), _jsxs("div", { className: "border border-gray-100 rounded-lg p-4 bg-gray-50", children: [_jsx("h3", { className: "font-medium text-gray-900 mb-2", children: "Shipping Method:" }), ship ? (_jsxs(_Fragment, { children: [_jsxs("p", { className: "text-sm text-gray-700", children: [ship.name, " - ", ship.price] }), ship.estimate && _jsxs("p", { className: "text-xs text-gray-600 mt-1", children: ["Estimated delivery: ", ship.estimate] })] })) : (_jsx("p", { className: "text-sm text-gray-500", children: "Please complete the delivery step." }))] }), _jsxs("div", { className: "border border-gray-100 rounded-lg p-4 bg-gray-50", children: [_jsx("h3", { className: "font-medium text-gray-900 mb-2", children: "Payment Method:" }), pay ? (_jsx("p", { className: "text-sm text-gray-700", children: pay.description })) : (_jsx("p", { className: "text-sm text-gray-500", children: "Please complete the payment step." }))] })] }), showTermsCheckbox && (_jsx("div", { className: "mb-6", children: _jsxs("label", { className: "flex items-start gap-3 cursor-pointer", children: [_jsx("input", { type: "checkbox", checked: agreed, onChange: (e) => onAgreedChange(e.target.checked), className: "mt-1 h-4 w-4" }), _jsxs("span", { className: "text-sm text-gray-700", children: ["I agree to the ", _jsx("a", { href: termsHref, className: "text-blue-600 hover:underline", children: "Terms and Conditions" }), " and ", _jsx("a", { href: privacyHref, className: "text-blue-600 hover:underline", children: "Privacy Policy" })] })] }) })), _jsxs("button", { onClick: onPlaceOrder, disabled: isProcessing || (showTermsCheckbox && !agreed), className: `w-full bg-black text-white rounded-lg hover:bg-gray-800 transition-colors font-medium flex items-center justify-center gap-2 ${buttonSize === 'large' ? 'py-4 text-lg' : 'py-3 text-base'} disabled:opacity-60 disabled:cursor-not-allowed`, children: [isProcessing ? _jsx(Spinner, { size: buttonSize === 'large' ? 20 : 18 }) : _jsx(Check, {}), isProcessing ? processingText : buttonText] }), showSecurityBadge && (_jsxs("div", { className: "mt-4 flex items-center justify-center gap-2 text-sm text-gray-600", children: [_jsx(Shield, {}), " ", _jsx("span", { children: "Secure checkout - Your payment info is encrypted" })] })), showPolicies && (_jsx("div", { className: "mt-4 pt-4 border-t border-gray-200", children: _jsxs("div", { className: "flex items-center justify-center gap-4 text-xs text-gray-600", children: [_jsx("a", { href: refundHref, className: "hover:underline", children: "Refund Policy" }), _jsx("span", { children: "\u2022" }), _jsx("a", { href: shippingPolicyHref, className: "hover:underline", children: "Shipping Policy" }), _jsx("span", { children: "\u2022" }), _jsx("a", { href: contactHref, className: "hover:underline", children: "Contact Us" })] }) }))] }));
    },
};

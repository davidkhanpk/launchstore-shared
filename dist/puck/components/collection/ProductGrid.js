...
const gapMap = { sm: '1rem', md: '1.5rem', lg: '2rem', xl: '3rem' };
const colsMap = {
    '2': 'md:grid-cols-2',
...
export const ProductGrid = {
    ...
    render: (raw) => {
        const { showTitle, title = 'Products', titleAlignment = 'left', layout = 'grid', columns = '4', gap = 'md', imageAspectRatio = 'square', showBadges, showQuickView, showWishlist, } = raw;

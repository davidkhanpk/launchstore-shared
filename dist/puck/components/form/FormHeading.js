...
import { FONT_SIZE_OPTIONS, FONT_WEIGHT_OPTIONS, TEXT_ALIGN_OPTIONS, LINE_HEIGHT_OPTIONS, SPACING_OPTIONS, resolveColor, } from '../../design-system';
...
export const FormHeading = {
    ...
    render: ({ text, fontSize, fontWeight, textAlign, lineHeight, textColor, marginBottom }) => (_jsx("p", { className: `text-${fontSize} font-${fontWeight} text-${textAlign} leading-${lineHeight} mb-${marginBottom}`, style: { color: resolveColor(textColor) }, children: text })),
};

export declare const categoryMegaMenuMeta: {
    ...
    readonly a11yNotes: "Renders inside a parent <nav> provided by MenuNavigation. Links use semantic <a> tags. No standalone ARIA needed.";

...
export const FilterBar = {
    ...
    render: (rawProps) => {
        ...
        if (layout === 'topbar') {
            return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "filterbar-desktop", style: {
                            display: 'none',
                            alignItems: 'center',
                        ...
                        }, children: [_jsx("style", { children: `@media (min-width: 768px) { .filterbar-desktop { display: flex !important; } .filterbar-mobile { display: none !important; } }` }), _jsxs("div", { style: { display: 'flex', alignItems: 'center', gap: '1rem' }, children: [props.showCount && typeof props.totalCount === 'number' && (_jsxs("span", { style: { fontSize: '0.875rem', color: '#6b7280' }, children: [props.totalCount, " products"] })), props.showFilters && (props.filterGroups || []).map((group) => (_jsxs("select", { defaultValue: "", onChange: (e) => e.target.value && onFilterChange(group.name, e.target.value), style: { padding: '0.375rem 0.75rem', border: '1px solid #d1d5db', borderRadius: '0.5rem', fontSize: '0.875rem', background: '#fff' }, children: [_jsx("option", { value: "", children: group.label || group.name }), group.values?.map((v) => (_jsxs("option", { value: v.value, children: [v.value, " (", v.count, ")"] }, v.value)))] }, group.name))), props.showClearAll && _jsx("button", { onClick: onClearAll, style: { fontSize: '0.875rem', color: '#6b7280', background: 'none', border: 'none', cursor: 'pointer' }, children: "Clear" })] }), props.showSort && (_jsx("select", { value: props.currentSort || 'created_desc', onChange: (e) => onSortChange(e.target.value), style: { padding: '0.375rem 0.75rem', border: '1px solid #d1d5db', borderRadius: '0.5rem', fontSize: '0.875rem', background: '#fff' }, children: SORT_OPTIONS.map((opt) => (_jsx("option", { value: opt.value, children: opt.label }, opt.value))) }))] }), _jsxs("div", { className: "filterbar-mobile", style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', padding: '0.75rem 0' }, children: [props.showSort && (_jsx("select", { value: props.currentSort || 'created_desc', onChange: (e) => onSortChange(e.target.value), style: { padding: '0.375rem 0.75rem', border: '1px solid #d1d5db', borderRadius: '0.5rem', fontSize: '0.875rem', background: '#fff', flex: 1 }, children: SORT_OPTIONS.map((opt) => (_jsx("option", { value: opt.value, children: opt.label }, opt.value))) })), props.showFilters && (_jsx("button", { onClick: () => setMobileOpen(true), style: { padding: '0.375rem 1rem', border: '1px solid #d1d5db', borderRadius: '0.5rem', fontSize: '0.875rem', fontWeight: 500, background: '#fff', cursor: 'pointer' }, children: "Filters" }))] }), _jsx(MobileFilterDrawer, { isOpen: mobileOpen, onClose: () => setMobileOpen(false), props: props, onSortChange: onSortChange, onFilterChange: onFilterChange, onClearAll: onClearAll })] }));
        }
        // "sidebar" layout (default) — left sidebar on desktop, drawer on mobile
        return (_jsxs(_Fragment, { children: [_jsxs("div", { className: "filterbar-desktop", style: { display: 'none' }, children: [_jsx("style", { children: `@media (min-width: 768px) { .filterbar-desktop { display: block !important; width: 16rem; flex-shrink: 0; } .filterbar-mobile { display: none !important; } }` }), _jsx("div", { style: { position: 'sticky', top: '1rem' }, children: _jsx(FilterContent, { props: props, onSortChange: onSortChange, onFilterChange: onFilterChange, onClearAll: onClearAll }) })] }), _jsxs("div", { className: "filterbar-mobile", style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '1rem', padding: '0.75rem 0' }, children: [props.showSort && (_jsx("select", { value: props.currentSort || 'created_desc', onChange: (e) => onSortChange(e.target.value), style: { padding: '0.375rem 0.75rem', border: '1px solid #d1d5db', borderRadius: '0.5rem', fontSize: '0.875rem', background: '#fff', flex: 1 }, children: SORT_OPTIONS.map((opt) => (_jsx("option", { value: opt.value, children: opt.label }, opt.value))) })), props.showFilters && (_jsx("button", { onClick: () => setMobileOpen(true), style: { padding: '0.375rem 1rem', border: '1px solid #d1d5db', borderRadius: '0.5rem', fontSize: '0.875rem', fontWeight: 500, background: '#fff', cursor: 'pointer' }, children: "Filters" }))] }), _jsx(MobileFilterDrawer, { isOpen: mobileOpen, onClose: () => setMobileOpen(false), props: props, onSortChange: onSortChange, onFilterChange: onFilterChange, onClearAll: onClearAll })] }));
    },
};

...
export const sharedTypographyFields = {
...
export const sharedLayoutFields = {
...
export const sharedColorFields = {
...
export const sharedBorderFields = {
...
export const sharedBackgroundFields = {
...
export const sharedSectionLayoutFields = {
...
export function buildTypographyClasses(props) {
...
export function buildColorClasses(props) {
    const { borderRadius } = props || {};
    return [
        borderRadius ? `rounded-${borderRadius}` : '',
    ].filter(Boolean).join(' ');
}
export function buildBorderClasses(props) {
...
export function buildBackground(props) {
    const { backgroundScheme, backgroundImage, backgroundSize, backgroundPosition, gradientFrom, gradientTo, backgroundColor, } = props || {};
    if (backgroundImage) {
        return {
            style: {
